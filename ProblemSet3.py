...
def problem3_1(txtfilename):
    ...
    for line in fname:
        ...
        print(line, end="")  
    print('\n')
    print("There are", lenn, "letters in the file")
...
def problem3_3(month, day, year):
    ...
    tup = ("January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December")           
    
    print (tup[month-1] , str(day)+"," , str(year))         
