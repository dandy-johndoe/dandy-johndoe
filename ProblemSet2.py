...
def problem2_7():
    ...
    l = input("Enter length of side one: ")
    b = input("Enter length of side two: ")
    h = input("Enter length of side three: ")
    l = float(l)
    h = float(h)
    b = float(b)
    ...
    print("Area of a triangle with sides", l, b , h, "is", A)
